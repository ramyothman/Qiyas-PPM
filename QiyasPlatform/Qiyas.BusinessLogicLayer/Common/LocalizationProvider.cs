...
{
    public class MvcLocalizationProvider : DataAnnotationsModelMetadataProvider
    {
        System.Resources.ResourceManager ui = null;

        public MvcLocalizationProvider(System.Resources.ResourceManager manager)
        {
            ui = manager;
        }
                ...
                if (attr != null)
                {
                    ...
                    if (typeName.Equals("DisplayAttribute"))
                    {
                        ...
                        if (!string.IsNullOrEmpty(sKey))
                        {
                            ...
                            sLocalizedText = ui.GetString(sKey);
