...
FROM     PPM.PackageWeight INNER JOIN
                  PPM.BookPackItem ON PPM.PackageWeight.PackageCode = PPM.BookPackItem.BookPackItemID
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'PackageWeightView';
