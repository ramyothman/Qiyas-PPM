...
SELECT PPM.BookPackItem.BookPackItemID, PPM.BookPackItem.BookPackingOperationID, PPM.BookPackItem.PackCode, PPM.BookPackItem.PackSerial, PPM.BookPackItem.Weight, PPM.BookPackItem.OperationStatusID, 
                  ...
                  PPM.BookPackingOperation.BookPrintingOperationID, PPM.PackagingType.Name AS PackageTypeName, PPM.BookPackItem.StartBookSerial, PPM.BookPackItem.LastBookSerial
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'ViewBookPackItemPrint';
